<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态" align="center" prop="omStatus">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.pr_status" :value="scope.row.omStatus"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            :disabled="scope.row.omStatus != '0'"
            @click="handlePlan(scope.row)"
            v-hasPermi="['system:post:arrange']"
          >下达</el-button>
          <el-button
            size="mini"
            type="text"
...
<script>
import { listOrder, delOrder, getOrder} from "@/api/workflow/bookmenu";
...
import { updateOrder } from "../../../api/workflow/bookmenu";
